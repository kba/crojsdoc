...
(function() {
  ...
  Renderer = (function() {
    function Renderer(result1, options1) {
      ...
      themeDir = resolve(__dirname, '../themes', this.options.theme || 'default');
      if (!fs.existsSync(themeDir)) {
        throw new Error("No such theme: '" + themeDir + "'");
      }
      this.resources_dir = resolve(themeDir, 'resources');
      this.templates_dir = resolve(themeDir, 'templates');
    }
    ...
    Renderer.prototype._renderOne = function(jade_options, template, output) {
      ...
      jade_options.options = this.options;
